...
<section class="edit-product-form" style="display: none;">
    <form id="editForm" enctype="multipart/form-data">
        ...
        <input type="text" name="update_name" id="update_name" class="box" required placeholder="Enter product name">
        <input type="number" name="update_price" id="update_price" min="0" class="box" required placeholder="Enter product price">
