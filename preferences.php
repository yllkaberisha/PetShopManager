...
<form action="" method="post">
    ...
    <div class="flex">
        <div class="inputBox">
            ...
            <input type="text" name="color"  placeholder="Enter your color" value="<?php echo $background_color; ?>">
        </div>
        <div class="inputBox">
            <span>Text color:</span>
            <input type="text" name="txtcolor"  placeholder="Enter your color" value="<?php echo $text_color; ?>">
        </div>
        <div class="inputBox">
            <span>Logo URL:</span>
        ...
        <div class="inputBox">
            ...
            <input type="text" name="fontfamily" placeholder="Enter font family" value="<?php echo $font_family; ?>">
        </div>
    </div>
