    ...
    <div class="sort-dropdown">
        <form action="" method="post">
            ...
            <select id="sort" name="sort_order" onchange="this.form.submit()">
                ...
                <option value="high-low" <?php echo $sortOrder == 'high-low' ? 'selected' : ''; ?>>Price (High-Low)
                </option>
                <option value="low-high" <?php echo $sortOrder == 'low-high' ? 'selected' : ''; ?>>Price (Low-High)
                </option>
            </select>
        </form>
    </div>
                ...
                foreach ($products as $fetch_products) {
                    ...
                    <form action="" method="post" class="box">
                        ...
                        <input type="hidden" name="product_image"
                            value="./uploaded_img/<?php echo $fetch_products['image']; ?>">
